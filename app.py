...
auth.set_access_token("XXXXXXXXXXXXXXXXXXX-XXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
api = tweepy.API(auth)
...
def tweets():
    if request.method == "POST":
        ...
        params = {
            ...
            "apiKey": "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",  # replace with your own API key
        }
